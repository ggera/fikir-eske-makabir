...
[![Text licence: CC BY-NC 4.0](https://img.shields.io/badge/text%20licence-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)
[![Code licence: MIT](https://img.shields.io/badge/code%20licence-MIT-yellow.svg)](LICENSE)
...
See the [Wikipedia article](https://en.wikipedia.org/wiki/Love_to_the_Grave) for further background.
...
**Source scan**
The original scanned PDF (`original-ፍቅር እስከ መቃብር.pdf`) is a 555-page image scan
created in March 2011 (Adobe Acrobat 10.0 / PDFScanLib v1.2.2) that has been
widely shared in the Ethiopian digital community.  If you know the definitive
original source, please open an issue or pull request to add proper credit.
